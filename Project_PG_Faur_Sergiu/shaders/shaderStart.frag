...
out vec4 fColor;
uniform int ready4Fog;
uniform int enablePunctiform;
//lighting
...
void main() 
{
	if(enablePunctiform==1)
	{ 
	   computeLightPunctiform();
	}
	else
	...
	//fColor = vec4(fogColor * (1 - fogFactor) + vec3(colorFromTexture) * fogFactor, 1.0f);;
